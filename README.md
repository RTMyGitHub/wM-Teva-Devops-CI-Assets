## Description
wM-Teva-Devops-CI-Assets is a library that easily enables CI for your webMethods projects. You can setup your infrastructure in minutes and then deploy flowlessly on your test service while also checking the quality
...
### CI Library
Download the library on your build server
...
## Notice
The wM Test Suite tests will have to be placed in a *setup* directory inside the test project, so that it can be picked up by the test executor.
